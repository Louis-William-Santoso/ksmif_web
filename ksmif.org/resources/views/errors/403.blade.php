...
<body>
    <div class="h-screen justify-center-safe place-items-center grid font-['Jersey10']">
        <div id="header" class="grid justify-center place-items-center sm:mt-[5%] mt-[20%] sm:mb-[11%] mb-64">
            ...
            <h3 class="lg:text-9xl sm:mt-3 text-7xl">403 Forbidden</h3>
            <h3 class="sm:text-3xl text-2xl m-5 text-pretty">It looks like your request was understood, but authorization is refused.</h3>
